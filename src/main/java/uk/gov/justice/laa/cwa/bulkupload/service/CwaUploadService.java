...
public class CwaUploadService {
   ...
   */
  public CwaSubmissionResponseDto processSubmission(String fileId, String userName,
      String provider) {
    if (fileId == null) {
    ...
    return restClient.post()
        .uri(
            cwaApiUrl + "/api/process_submission", uriBuilder -> uriBuilder
   ...
   */
  public List<CwaUploadSummaryResponseDto> getUploadSummary(String fileId, String userName,
      String provider) {
    return restClient.get()
        .uri(
            cwaApiUrl + "/api/get_bulkload_summary", uriBuilder -> uriBuilder
                .queryParam("username", userName)
                .queryParam("am_bulk_file_id", fileId)
                .queryParam("vendor_id", provider)
                .build())
   ...
   */
  public List<CwaUploadErrorResponseDto> getUploadErrors(String fileId, String userName,
      String provider) {
    return restClient.get()
        .uri(
            cwaApiUrl + "/api/get_bulkload_errors", uriBuilder -> uriBuilder
                .queryParam("username", userName)
                .queryParam("am_bulk_file_id", fileId)
                .queryParam("vendor_id", provider)
                .build())
